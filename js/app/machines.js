...
app.controller("MachineCtrl", ['$scope', '$log', '$window', '$timeout', 'MachineService', 'socket', function ($scope, $log, $window, $timeout, MachineService, socket) {
	...
	$scope.message_alert = new $scope.Alert({
		...
		message: "Check out the code on <a href='https://github.com/bencentra/WebDrink-2.0/'>GitHub</a> and report any <a href='https://github.com/bencentra/WebDrink-2.0/issues'>issues</a>.",
		show: true,
		closeable: false
	});
